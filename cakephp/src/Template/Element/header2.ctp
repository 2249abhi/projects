      ...
      <div class="menu-block-wrapper menu-block-2 menu-name-main-menu parent-mlid-0 menu-level-1">
        <ul class="menu" id="nav">
         ...
         <!-- <li class="menu__item is-expanded expanded menu-mlid-3498"><?php echo $this->Html->link('GIS',['controller' => 'gis', 'action' => 'index'], array('class' => 'menu__link', 'role' => 'link'));?> </li>
          <li class="menu__item is-expanded expanded menu-mlid-3498"><?php echo $this->Html->link('GIS','http://134.209.222.136/coop_gis/home.html',  array('class' => 'menu__link', 'role' => 'link', 'target' => '_blank'));?> </li> -->

          <li class="menu__item is-expanded expanded menu-mlid-3498"><?php echo $this->Html->link('GIS', BASE_URL.'/map_gis/index_covered.php?pacs_covered20',  array('class' => 'menu__link', 'role' => 'link', 'target' => '_blank'));?> </li>		 
