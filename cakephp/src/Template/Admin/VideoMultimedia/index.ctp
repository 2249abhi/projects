  ...
  <section class="content galleryCategory index">
      ...
      <div class="col-md-12">
        ...
        <div class="box box-primary">
          <div class="box-header">
              <h3 class="box-title"><?= __('Search - Video Multimedia'); ?></h3>
          </div> 
          <?= $this->Form->create('videoMultimedia',['id' =>'searchPhoto','type'=>'get']); ?>
    ...
    <div class="row">
      ...
      <?= $this->Flash->render() ; ?>
        <div class="box box-primary">
          <div class="box-header">
            <h3 class="box-title"><?= __('List of') ?> <?= __('Videos') ?></h3>
            <div class="box-tools">
              <?=$this->Html->link(
                __('<i class="glyphicon glyphicon-plus"></i> Add New Video'),
                ['action' => 'add'],
