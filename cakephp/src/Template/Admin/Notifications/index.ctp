          ...
          <?= $this->Form->create('searchBanner',['id' =>'searchBanner','type'=>'get']); ?>
            <div class="box-body table-responsive">
              ...
              <div class="row2">    
                ...
                <div class="col-md-1"><label for="page_name">News Description</label></div>
                <div class="col-md-3">
                  <div class="form-group">
                    <input type="text" name="description" id="description" placeholder="Enter News Description" class="form-control" value=<?=@$description?>>
                  </div>
                </div>
                ...
                <div class="col-md-1">
                  ...
                  <?php } else { ?>
                    <?= $this->Html->link(__('Reset'),['controller'=>'Notifications','action'=>'index'],['class'=>'btn btn-danger']); ?>
                  <?php }?>
                </div>
          ...
          <?= $this->Form->create('page_number',['id'=>'role_list','type'=>'get','class'=>'form-inline']); ?>
            <div class="box-header">
              ...
              <div class="box-tools">
                ...
                <?=$this->Html->link(
                    __('<i class="glyphicon glyphicon-plus"></i> New Notifications'),
                    ['action' => 'add'],
                    ['class' => 'btn btn-success', 'escape' => false, 'title' => __('Add New Notifications')]
                );?>                
              </div>              
            </div>
            <div class="clearfix"></div>
            ...
            <table class="table table-hover table-bordered">
              <thead>
                <tr>
                    ...
                    <th scope="col"><?= $this->Paginator->sort('notification_date',"News Date") ?></th>
                    <th scope="col"><?= $this->Paginator->sort('notification_order',"News Order") ?></th>
              ...
              <tbody>
				...
				foreach ($document_types as $role): ?>
                  <tr>
                    ...
                    <td><?= date('Y-m-d',strtotime($role->notification_date)) ?></td>
                    <td><?= h($role->notification_order) ?></td>
                    ...
                    <td class="actions">
                        ...
                        <?= $this->Form->postLink('<i class="fa fa-trash-o"></i>', ['action' => 'delete', $role->id], ['confirm' => __('Are you sure you want to delete this Notifications?', $role->id),'class' => 'btn btn-danger btn-xs', 'title' => __('Delete'), 'escape' => false]) ?>
                      </td>
                    </tr>
                    <?php $i++; endforeach; ?>
