...
<section class="content Cooperative Registration index">
        ...
        <div class="col-xs-12">
            ...
            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title"><?= __('Search - List of Cooperative Society'); ?></h3>
                </div>
                ...
                <div class="box-body table-responsive">
                    ...
                    <div class="row3">
                        ...
                        <div class="col-md-1">
                            <?= $this->Html->link(__('Reset'),['controller'=>'CooperativeRegistrations','action'=>'my'],['class'=>'btn btn-danger']); ?>
                        </div>
                    </div>
                    <div class="clearfix"></div>
                    <br>
    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title"><?= __('List of') ?> <?= __('Cooperative Registrations') ?></h3>
                    <div class="box-tools">
                        <?=$this->Html->link(
