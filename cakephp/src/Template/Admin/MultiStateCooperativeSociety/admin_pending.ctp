...
$this->assign('content_header',__('List of Cooperative Registrations Pending'));
					...
					<div class="row3">
						<div class="col-md-12 text-center">
							<button name="search_button" value="search_button" type="submit" class="btn btn-primary btn-green">Search</button>
							  <?= $this->Html->link(__('Reset'),['controller'=>'CooperativeRegistrations','action'=>'adminPending'],['class'=>'btn btn-danger mx-1']); ?>
						</div>
					</div>
