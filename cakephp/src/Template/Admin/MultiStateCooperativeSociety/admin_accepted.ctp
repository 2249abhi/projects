...
$this->assign('content_header',__('List of Cooperative Registrations All Approved'));
        ...
        <div class="col-xs-12">
            ...
            <div class="box box-primary">
                <div class="box-header" >
                    <h3 class="box-title titleSrch"><?= __('Search - Cooperative Society Approved'); ?></h3>
					<div class="SrchBx">
					...
					<div class="row3">
						<div class="col-md-12 text-center">
							<button name="search_button" value="search_button" type="submit" class="btn btn-primary btn-green">Search</button>
							  <?= $this->Html->link(__('Reset'),['controller'=>'CooperativeRegistrations','action'=>'adminAccepted'],['class'=>'btn btn-danger mx-1']); ?>
						</div>
					</div>
