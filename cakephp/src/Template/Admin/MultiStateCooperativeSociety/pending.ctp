...
$this->assign('content_header',__('List of Pending Cooperative Registrations'));
        ...
        <div class="col-xs-12">
            ...
            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title titleSrch"><?= __('Search - Cooperative Society Pending'); ?></h3>
                    <div class="SrchBx">
                ...
                <div class="box-body table-responsive">
                    ...
                    <div class="row3">
                        <div class="col-md-12 text-center">
                            ...
                            <?= $this->Html->link(__('Reset'),['controller'=>'CooperativeRegistrations','action'=>'pending'],['class'=>'btn btn-danger mx-1']); ?>
                        </div>
                    </div>
                ...
                <div style="margin-right: 3px;float: right;margin-top: 10px;">
                    <button name="export_excel" value="export_excel" class="mt4px btn btn-primary1 btn-green" style="background-color: #4fe741;
    color: white;">Export to Excel</button>
                    </div>
                    <?php } ?>
                <?= $this->Form->end(); ?>
            </div>
        ...
        <div class="col-xs-12">
            ...
            <div class="box box-primary box-st">
                ...
                <div class="box-body table-responsive">
                    ...
                    <table class="table table-hover table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <th scope="col"><?= $this->Paginator->sort('created_by','Created By') ?></th>
                            ...
                            <tr>
                                <td colspan="10"></td>
                                <td><?php echo $this->Form->checkbox('select_all', array('id'=>'checkall', 'name' => 'select_all', 'class'=>'select_all', 'checked' => false, 'hiddenField' => false)); ?> Check All</td>
                            </tr>
                        </thead>
                        <tbody>
                            <?php 
                            ...
                            <tr>
                                ...
                                <td><?= $user_all[$CooperativeRegistration->created_by]?></td>
                                ...
                                <td class="actions">
                                    ...
                                    if($this->request->session()->read('Auth.User.role_id') == 8 )
                                    {
                                        ...
                                        echo $this->Html->link('<i class="fa fa-eye"></i>', ['action' => 'view', $CooperativeRegistration->id],['class' => 'btn btn-info btn-xs', 'title' => __('View'), 'escape' => false,'style'=>'margin-left:5px;']);
                                        ...
                                        echo $this->Html->link('<i class="fa fa-edit"></i>', ['action' => 'edit', $CooperativeRegistration->id],['class' => 'btn btn-info', 'title' => __('Edit'), 'escape' => false]);
                    ...
                    <?php if($CooperativeRegistration->is_approved == 0 && $this->request->session()->read('Auth.User.role_id') == 8 && count($CooperativeRegistrations) > 0){ ?>
