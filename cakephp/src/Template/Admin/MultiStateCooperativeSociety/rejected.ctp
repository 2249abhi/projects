        ...
        <div class="col-xs-12">
            ...
            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title titleSrch"><?= __('Search - Cooperative Society Return For Correction'); ?>
                    </h3>
                    <div class="SrchBx">
                ...
                <div class="box-body table-responsive">
                    ...
                    <div class="row3">
                        <div class="col-md-12 text-center">
                            ...
                            <?= $this->Html->link(__('Reset'),['controller'=>'CooperativeRegistrations','action'=>'rejected'],['class'=>'btn btn-danger mx-1']); ?>
                        </div>
                    </div>
          ...
          <button name="export_excel" value="export_excel" class="mt4px btn btn-primary1 btn-green" style="background-color: #4fe741;color: white;">
            ...
            <div class="box box-primary box-st">
                    ...
                    <table class="table table-hover table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <th scope="col"><?= $this->Paginator->sort('approval_status','Approval Status') ?></th>
                ...
                ?>
                      ...
                      ?>
                                ...
                                <?php $approval_status = ['0'=>'Pending','1'=>'Accepted']; ?>
                                <td><?= $approval_status[$CooperativeRegistration->is_approved]; ?></td>
