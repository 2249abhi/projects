 ...
 */
$this->assign('title',__('Parliament'));
$this->Breadcrumbs->add(__('Parliament'));
      ...
      <div class="col-md-12">
        ...
        <div class="box box-primary">
          <div class="box-header">
              <h3 class="box-title"><?= __('Search - Parliament'); ?></h3>
          </div> 
          ...
          <?= $this->Form->create('page_number',['id'=>'role_list','type'=>'get','class'=>'form-inline']); ?>
            <div class="box-header">
              ...
              <div class="box-tools">
                ...
                <?=$this->Html->link(
                    __('<i class="glyphicon glyphicon-plus"></i> New Parliament'),
                    ['action' => 'add'],
                    ['class' => 'btn btn-success', 'escape' => false, 'title' => __('Add New Parliament')]
                );?>                
              </div>              
            </div>
            <div class="clearfix"></div>
