 ...
 */
$this->assign('title',__('Parliament ( ' . $role->title . ' ) '));
$this->Breadcrumbs->add(__('Parliament'),['action'=>'index']);
$this->Breadcrumbs->add(__('Parliament ( ' . $role->title . ' ) '));
?>
        ...
        <div class="col-md-12">
           <div class="box box-solid">
              <div class="box-header with-border">
                 ...
                 <h3 class="box-title"><?= __('Parliament ( ' . $role->title . ' ) ') ?></h3>
          ...
          <table class="table table-striped table-bordered">
                    <tr>
                      <th scope="row"><?= __('Parliament Type') ?></th>
                      <td><?= h($types[$role->parliament_type_id]) ?></td>
                      <th><?= __('Title') ?></th>
                      <td><?= h($role->title) ?></td>
                    </tr>
                    <tr> 
                      <th scope="row"><?= __('Content') ?></th>
                      <td><!-- <?= h($role->content) ?> --></td>
                      <th><?= __('Priority') ?></th>
