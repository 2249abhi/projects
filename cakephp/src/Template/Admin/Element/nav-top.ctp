      ...
      <li class="dropdown user user-menu">
        ...
        <ul class="dropdown-menu">
          ...
          <li class="user-footer">
            <div class="pull-left">
              <?=$this->Html->link('Setting',['controller' => 'users', 'action' => 'change-password', '_full' => false],['class'=>'btn btn-default btn-flat']); ?>
            </div>
            <div class="pull-right">
              <?=$this->Html->link('Sign out',['controller' => 'users', 'action' => 'logout', '_full' => false],['class'=>'btn btn-default btn-flat']); ?>
            </div>
          </li>
        </ul>
      </li>
