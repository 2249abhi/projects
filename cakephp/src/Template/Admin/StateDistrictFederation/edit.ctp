    ...
    <div class="row">
        ...
        <div>
            ...
            <div class="box box-primary">
                ...
                <?php
              echo $this->Form->create($StateDistrictFederation,['id' => 'RevisedForm','type'=>'file']);?>
                <div class="box-body">
                    <div class="boxk">
                        <div class="row">
                            <div class="col-sm-4">
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                ...
                                <input type="hidden" name="curr_id" id="curr_id" value="<?= $StateDistrictFederation->id ?>" />
                            </div>
                    ...
                    <div class="box-block-m">
                        ...
                        <div class="col-sm-4 rural_location_section"
                            style="display:<?= $StateDistrictFederation->location_of_head_quarter==1?'none':'block';?>;">
                        ...
                        <div class="col-sm-4 urban_location_section"
                            style="display: <?=$StateDistrictFederation->location_of_head_quarter==1?'block':'none';?>;">
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="row">
                                <div class="col-sm-3 pd-lr_0">
                                    <?=$this->Form->control('std',['type'=>'textbox', 'class'=>'number','placeholder'=>'STD Code','maxlength'=>'4','label'=>false,'style'=>'width:82px;', 'value'=>explode('-',$StateDistrictFederation->landline)[0]])?>
                                </div>
                                <div class="col-sm-9 pd-lr_0">
                                    <?=$this->Form->control('landline',['type'=>'textbox','class'=>'number','placeholder'=>'Landline Number', 'maxlength'=>'8','label'=>false, 'value'=>explode('-',$StateDistrictFederation->landline)[1]])?>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-4">
                    ...
                    <div class="box-block-m">
                        ...
                        <div class="col-sm-4 set-form-check">
                            ...
                            <?=$this->Form->control('operation_area_location',['options'=>[1=>'Urban',2=>'Rural',3=>'Both'],'id'=>'operation_area_location','class'=>'operation_area_location','default'=>'2','type' => 'radio','label'=>false,'required'=>true, 'value'=>$StateDistrictFederation->operation_area_location])?>
                        </div>
                        ...
                        <div class="sector_urban_location_section urban_ward_box"
                            style="display:<?= $StateDistrictFederation->operation_area_location==1 || $StateDistrictFederation->operation_area_location==3 ?'block':'none';?>;">
                            <b style="margin-left:15px;text-decoration: underline;">Urban</b>
                            <br>
                           
                            <div class="clearfix"></div>
                            <?php if(count($sector_details_urban)!=0){
                                foreach($sector_details_urban as $key=>$sector_detail_urban_obj){ ?>

                            <div class="clearfix"></div>
                           
                            <div class="urban_ward_rows" rowclass="<?=$key?>">
                                <div class="col-sm-3 urban_location_section1">
                                    <label>4(c)(i). District <span class="important-field">*</span></label>
                                    <?=$this->Form->control("sector_urban.$key.district_code",['options'=>$districts,'empty'=>'Select','increment'=>$key,'label'=>false,'class'=>'sector_urban_district_code select2','type'=>'select','required'=>true, 'value'=>$sector_detail_urban_obj->district_code])?>
                                </div>

                                <div class="col-sm-3 urban_location_section1" style="display: block;">
                                    <label>4(c)(ii). Category of Urban Local Body <span
                                            class="important-field">*</span></label>
                                    <?=$this->Form->control("sector_urban.$key.local_body_type_code",['options'=>$localbody_types,'empty'=>'Select','increment'=>$key,'label'=>false,'class'=>'select2 sector_urban_local_body_type_code','required'=>true, 'value'=>$sector_detail_urban_obj->local_body_type_code])?>
                                </div>

                                <div class="col-sm-3 urban_location_section1" style="display: block;">
                                    <label>4(c)(iii). Urban Local Body <span class="important-field">*</span></label>
                                    <?=$this->Form->control("sector_urban.$key.local_body_code",['options'=>$sector_details_local_bodies[$key],'empty'=>'Select','label'=>false,'increment'=>$key,'class'=>'select2 sector_urban_local_body_code','required'=>true,  'value'=>$sector_detail_urban_obj->local_body_code])?>
                                </div>
                        ...
                        <div class="sector_rural_location_section rural_village_box"
                            style="display:<?= $StateDistrictFederation->operation_area_location==2 || $StateDistrictFederation->operation_area_location==3 ?'block':'none';?>;">
                            <b style="margin-left:15px;text-decoration: underline;">Rural</b>
                           
                            <div class="clearfix"></div>
                            <?php if(count($sector_details_rural)!=0){
                                 foreach($sector_details_rural as $key=>$sector_detail_rural_obj){ ?>
                            <div class="clearfix"></div>
                            

                            <div class="rural_village_rows extra_rural_rows" rowclass="<?=$key?>">
                                    <div class="col-sm-3 rural_location_section1">
                                    <label>4(c)(i). District <span class="important-field">*</span></label>
                                    <?=$this->Form->control("sector.$key.district_code",['options'=>$districts,'empty'=>'Select','increment'=>$key,'label'=>false,'class'=>'sector_district_code select2','type'=>'select','required'=>true, 'value'=> $sector_detail_rural_obj->district_code ])?>
                                </div>

                                <div class="col-sm-3 rural_location_section1">
                                    <label>4(c)(ii). Block <span class="important-field">*</span></label>
                                    <?=$this->Form->control("sector.$key.block_code",['options'=>$sector_details_blocks[$key],'empty'=>'Select','increment'=>$key,'label'=>false,'class'=>'sector_block_code select2','type'=>'select','required'=>true, 'value'=>$sector_detail_rural_obj->block_code])?>
                                </div>
                        ...
                        <div class="col-sm-3 area_operation_change2 ex-div"
                            style="display:block;">
                            <label>4(f). Whether the Federation is affiliated to Union/Federation?<span
                                    class="important-field">*</span></label>
                            <?=$this->Form->control('is_affiliated_union_federation',['options'=>['1'=>'Yes','0'=>'No'],'class'=>'is_affiliated','default'=>0,'type'=>'radio','label'=>false,'required'=>true, 'value'=>$StateDistrictFederation->is_affiliated_union_federation])?>
                        </div>
                        ...
                        <div class="col-sm-3 is_affiliated_change" id="affiliated_union_federation_level_div"
                            style="display:<?=$StateDistrictFederation->is_affiliated_union_federation==1?'block':'none';?>;">
                            ...
                            <?= $this->Form->control('affiliated_union_federation_level',['options'=>$sector_details_affiliation_level,'empty'=>'Select','label'=>false,'class'=>'select2','required'=>true, 'value'=>$StateDistrictFederation->affiliated_union_federation_level])?>
                        </div>
                        ...
                        <div class="col-sm-3 is_affiliated_change 5g" id="affiliated_union_federation_name_div"
                            ...
                            <label>4(h). Name of Affiliated Union/Federation<span
                                    class="important-field">*</span></label>
                            <?php //if($StateDistrictFederation->affiliated_union_federation_name ==-1){
                              //$SecondaryActivities = ["-1"=>'Other'];
                            //} ?>
                            <?= $this->Form->control('affiliated_union_federation_name',['options'=>$SecondaryActivities,'empty'=>'Select','label'=>false,'class'=>'select2 affiliated_union_federation_name','required'=>true,'onchange'=>'for_other_affiliated(this)', 'value'=>$StateDistrictFederation->affiliated_union_federation_name])?>
                        </div>


                        <div class="col-sm-3 is_affiliated_change_other 5g_other" id="5g_other_div"
                            style="display:<?=$StateDistrictFederation->is_affiliated_union_federation == 1 && $StateDistrictFederation->affiliated_union_federation_name ==3 || $StateDistrictFederation->is_affiliated_union_federation == 1 && $StateDistrictFederation->affiliated_union_federation_name ==-1?'block':'none';?>;">
                    ...
                    <div class="box-block-m">
                        ...
                        <div class="col-sm-3">
                            <label>6(a). Whether the Primary Cooperative is the member of the Federation?<span
                                    class="important-field">*</span></label>
                            <?=$this->Form->control("is_federation_member",['options'=>['1'=>'Yes','0'=>'No'],'default'=>1,'class'=>'is_society_member','type'=>'radio','label'=>false,'required'=>true, 'onclick'=>'is_coop_society_member(this)', 'value'=>$StateDistrictFederation->is_federation_member])?>
                        </div>
                        <!-- <div class="clearfix"></div> -->
                        <?php if($this->request->session()->read('Auth.User.role_id') == 7 || $this->request->session()->read('Auth.User.role_id') == 8){ ?>
                            <div class="col-sm-3 rural_location_section1">
                                    ...
                                    <?=$this->Form->control("all_district",['options'=>$districts,'empty'=>'Select','label'=>false,'class'=>'all_district select2','type'=>'select','required'=>true])?>
                                </div>
                        <?php } ?>
                        <div class="col-sm-3">
                        ...
                        <div class="col-sm-3" id="federation-member-count-div"
                            style="display:<?= $StateDistrictFederation->is_federation_member == 1 ? 'block' : 'none'; ?>;">
                            <label>6(b). Number of Members<span class="important-field">*</span></label>
                            <?=$this->Form->control('primary_cooperative_member_count',['type'=>'textbox','class'=>'number','placeholder'=>'Total number of Members','label'=>false,'required'=>true])?>
                        </div>
                                    ...
                                    <table class="table table-striped table-white table-bordered" id="tab_logic2">
                                        <thead class="table-sticky-header">
                                            <tr style="background-color: #599ec6; color: #fff;">
                                                ...
                                                <th style="width: 15%">
                                                    Mark Cooperative Federation<br/>If A Member
                                                </th>
                                            </tr>
                    ...
                    <div class="box-block-m">
                        ...
                        <div class="col-sm-3">
                            ...
                            <?=$this->Form->control("other_member",['options'=>['1'=>'Yes','0'=>'No'],'default'=>0,'class'=>'other_member','type'=>'radio','label'=>false,'required'=>true ,'value'=>$StateDistrictFederation->other_member ])?>
                        </div>
                        <div class="col-sm-3 other_section"
                            style="display:<?= $StateDistrictFederation->other_member == 1 ? 'block' : 'none'; ?>;">
                            <label>7(b) Number of Members<span class="important-field">*</span></label>
                            <?=$this->Form->control('other_member_count',['type'=>'textbox','readonly'=>true,'class'=>'number','placeholder'=>'Number of Members','label'=>false,'required'=>true, 'value'=>$StateDistrictFederation->other_member_count])?>
                        </div>

                        <div class="col-sm-12 other_section other_section_box"
                            style="display:<?= $StateDistrictFederation->other_member == 1 ? 'block' : 'none'; ?>;">

                            <?php if(count($sd_federation_other_members)!=0):
                        foreach ($sd_federation_other_members as $ohr2 => $sd_federation_other_member):
                       ?>
                            <div class="other_member_rows" rowclass="<?=$ohr2?>">
                                <div class="col-sm-3">
                                    ...
                                    <?=$this->Form->control("sd_federation_other_members.$ohr2.type_membership",['options'=>$arr_other_type_member,'empty'=>'Select','label'=>false,'class'=>'other_type_membership select2','inc'=>$ohr2,'required'=>true, 'value'=>$sd_federation_other_member->type_membership])?>
                                </div>
                                <div class="col-sm-3">
                                    ...
                                    <?=$this->Form->control("sd_federation_other_members.$ohr2.class_membership",['options'=>$arr_class_member,'empty'=>'Select','label'=>false,'class'=>'building_type select2','required'=>true, 'value'=>$sd_federation_other_member->class_membership])?>
                                </div>
                                <div class="col-sm-3">
                                    <label>Name of Organisation<span class="important-field">*</span></label>
                                    <?=$this->Form->control("sd_federation_other_members.$ohr2.org_name",['type'=>'textbox','placeholder'=>'Name of Organisation','label'=>false,'class'=>'org_name','required'=>true, 'maxlength'=>'200', 'value'=>$sd_federation_other_member->org_name])?>
                                </div>

                                <div class="col-sm-3 <?= $ohr2 ?>individual_div"
                                    style="display:<?= $sd_federation_other_member->type_membership == 2 ? 'none' : 'block'; ?>;">
                                    <label>Primary Activities/Sector<span class="important-field">*</span></label>
                                    <?=$this->Form->control("sd_federation_other_members.$ohr2.primary_activity",['options'=>$PrimaryActivitiesTotal,'empty'=>'Select','readonly'=>true,'label'=>false,'class'=>$ohr2.'individual_input select2','required'=>true, 'value'=>$sd_federation_other_member->primary_activity])?>
                                    <?php //$this->Form->control("sd_federation_other_members.$ohr2.member_type",['type'=>'hidden','value'=>'1'])?>
                                </div>
                                <div class="col-sm-3 <?= $ohr2 ?>individual_div"
                                    style="display:<?= $sd_federation_other_member->type_membership == 2 ? 'none' : 'block'; ?>;">
                                    <label>District<span class="important-field">*</span></label>
                                    <?=$this->Form->control("sd_federation_other_members.$ohr2.district_code",['options'=>$districts,'empty'=>'Select','label'=>false,'class'=>$ohr2.'individual_input select2','type'=>'select','required'=>true, 'value'=>$sd_federation_other_member->district_code])?>
                                </div>
                                <div class="col-sm-3 <?= $ohr2 ?>individual_div"
                                    style="display:<?= $sd_federation_other_member->type_membership == 2 ? 'none' : 'block'; ?>;">
                                    <label>Address<span class="important-field">*</span></label>
                                    <?=$this->Form->control("sd_federation_other_members.$ohr2.address",['type'=>'textbox','placeholder'=>'Address','label'=>false,'class'=>$ohr2.'individual_input','required'=>true, 'maxlength'=>'200', 'value'=>$sd_federation_other_member->address])?>
                                </div>
                                <div class="col-sm-3 <?= $ohr2 ?>individual_div"
                                    style="display:<?= $sd_federation_other_member->type_membership == 2 ? 'none' : 'block'; ?>;">
                                    <label>Phone Number<span class="important-field">*</span></label>
                                    <?=$this->Form->control("sd_federation_other_members.$ohr2.phone_number",['type'=>'textbox','placeholder'=>'Phone Number','label'=>false,'class'=>$ohr2.'individual_input number','required'=>true, 'maxlength'=>'10', 'value'=>$sd_federation_other_member->phone_number])?>
                                </div>
                                <div class="col-sm-3 <?= $ohr2 ?>individual_div"
                                    style="display:<?= $sd_federation_other_member->type_membership == 2 ? 'none' : 'block'; ?>;">
                                    <label>Email<span class="important-field">*</span></label>
                                    <?=$this->Form->control("sd_federation_other_members.$ohr2.email",['type'=>'email','placeholder'=>'Email','label'=>false,'class'=>$ohr2.'individual_input','required'=>true, 'maxlength'=>'200', 'value'=>$sd_federation_other_member->email])?>
                                </div>
                               <!-- <div class="col-md-3 <?= $ohr2 ?>individual_upload_div"
                                    style="display:<?= $sd_federation_other_member->type_membership == 2 ? 'block' : 'none'; ?>;">
                                    <div class="">
                                        <div><label>Document </label>&nbsp;&nbsp;<a
                                                href="<?=$this->request->webroot?>files/member_document/<?= $sd_federation_other_member->member_document ?>"
                                                target="_blank" download><i class="fa fa-download"></i></a></div>
                                        <?php echo $this->Form->control("sd_federation_other_members.$ohr2.member_document",['label' => false,'type' =>'file','class'=>$ohr2.'individual_upload_input','required'=>false,'accept'=>'application/pdf','value'=>$sd_federation_other_member->member_document]);?>
                                    </div>
                                </div> -->

                                <div class="col-md-3 <?= $ohr2 ?>individual_upload_div"
                                style="display:<?= ($sd_federation_other_member->type_membership == 2 || $sd_federation_other_member->type_membership == 3) ? 'block' : 'none'; ?>;">
                                
                                <label>9(f).Document</label>&nbsp;&nbsp;<a class="<?= $ohr2 ?>_file" href="<?=$this->request->webroot?>files/member_document/<?= $sd_federation_other_member->member_document ?>" target="_blank" download><i class="fa fa-download"></i></a>
                                <?php 
                                $accept = '';
                                if($sd_federation_other_member->type_membership == 2)
                                {
                                    $accept = 'application/pdf';
                                }

                                if($sd_federation_other_member->type_membership == 3)
                                {
                                    $accept = '.csv,text/csv';
                                }
                                
                                echo $this->Form->control("sd_federation_other_members.$ohr2.member_document",['label' => false,'type' =>'file','class'=>$ohr2.'individual_upload_input','required'=>false,'accept'=>$accept,'value'=>$sd_federation_other_member->member_document]);?>
                                ...
                                <div class="col-md-3 <?= $ohr2 ?>individual_upload_div"
                                    ...
                                    <div class="">
                                        ...
                                        <?php echo $this->Form->control("sd_federation_other_members.$ohr2.member_count",['label' => false,'type' =>'text','class'=>$ohr2.'individual_upload_input docu number','maxlength'=>'7','required'=>true,'value'=>$sd_federation_other_member->member_count]);?>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <button type="button"
                            ...
                            <?php $ohr2=0;?>
                             <div class="other_member_rows" rowclass="<?=$ohr2?>">
                                ...
                                <div class="col-md-3 <?= $ohr2 ?>individual_upload_div" style="display:none;">
                                    <div class="">
                                        <div><label>17(f).Document <span style="color:red;"
                                                    class="dtype"></span></label>
                                        </div>
                    ...
                    <div class="box-block-m">
                        ...
                        <div class="col-sm-4 list_of_bank none-selected-div--2 "
                            style="display:<?= !in_array(1,$StateDistrictFederation->bank_type) ? 'none' : 'block'; ?>">
                            <label>9(b). Bank name where the cooperative federation has its bank account:<span
                                    class="important-field">*</span></label>
                            <?=$this->Form->control('cooperative_society_bank_id',['options'=>$arr_banks,'placeholder'=>'Select Bank Type','label'=>false,'class'=>'multiselect bank_id not_functional','required'=>true,'multiple'=>true])?>
                        </div>
                        <div class="col-sm-4 bank_other"
                            style="display:<?php echo in_array('38',$StateDistrictFederation->cooperative_society_bank_id) ? 'block' : 'none'; ?>;">
                        ...
                        <div class="col-sm-4 housing_has_building_change"
                            style="display:<?= $StateDistrictFederation->has_building == '1' ? 'block' : 'none'; ?>;">
                        ...
                        <div class="col-sm-3 rdb">
                            <label>11. Is the Federation/State Cooperative Federation doing a business activity? <span
                                    class="important-field">*</span></label>
                        ...
                        <div class="clearfix"></div>
                        <div class="col-sm-3 rdb" id="is_profit_making_div"
                            style="display:<?= $StateDistrictFederation->federation_doing_business == '1' ? 'block' : 'none'; ?>;">
                        ...
                        <div class="col-sm-3 total_loss" id="annual_loss_div"
                            style="display:<?= $StateDistrictFederation->is_profit_making == '0' ? 'block' : 'none'; ?>;">
                        ...
                        <div class="col-sm-3 total_revenue" id="annual_turnover_div"
                            style="display:<?= $StateDistrictFederation->is_profit_making == '1' ? 'block' : 'none'; ?>;">
                        ...
                        <div class="col-sm-3 rdb" id="is_dividend_paid_div"
                            style="display:<?= $StateDistrictFederation->federation_doing_business == '1' ? 'block' : 'none'; ?>;">
                            <label>11(c). Whether the dividend is paid by the Cooperative Federation? <span
                                    class="important-field">*</span></label>
                            <?=$this->Form->control('is_dividend_paid',['options'=>['1'=>'Yes','0'=>'No'],'default'=>0,'class'=>'dividend not_functional','type'=>'radio','label'=>false,'required'=>true])?>
                        </div>
                        ...
                        <div class="col-sm-3 dividend_change"
                            style="display:<?=$StateDistrictFederation->is_dividend_paid == 1 ?'block' : 'none' ;?>;"
                            id="dividend_rate_div">
                            <label>11(d). Dividend Rate Paid by the Cooperative Federation (in %)<span
                                    class="important-field">*</span></label>
                            <?=$this->Form->control('dividend_rate',['turn_over'=>'textbox','placeholder'=>'Dividend Rate Paid','label'=>false,'required'=>true,'class'=>'numberadndesimal not_functional', 'maxlength'=>'6'])?>
                        </div>
                        ...
                        <div class="col-sm-3" id="auth_share_div" style="display:<?= $StateDistrictFederation->federation_doing_business == '1' ? 'block' : 'none'; ?>;">
                        ...
                        <div class="col-sm-3" id="turnover_div" style="display:<?= $StateDistrictFederation->federation_doing_business == '1' ? 'block' : 'none'; ?>;">
                            <label>11(f). Annual Turn Over of the Cooperative Federation (Rs in Lakh)<span
                                    class="important-field">*</span></label>
                        ...
                        <div class="clearfix"></div>
                        <div class="col-sm-3 rdb">
                            <label>12. Is the Federation/State Cooperative Federation doing marketing?
                        ...
                        <div class="col-sm-3 marketing_change"
                            style="display:<?=$StateDistrictFederation->federation_doing_marketing == 1 ?'block' : 'none' ;?>;">
                        ...
                        <div class="box-block-m">
                            <div class="col-sm-12">
                                ...
                                <div class="row sv-handling">
                                    ...
                                    <div class="col-sm-4 d_credit_facility_change" style="display:<?= $sd_fed_dairy->credit_facility == '1' ? 'block' : 'none'; ?>;">
                                    ...
                                    <div class="clearfix"></div>
                                    <div class="col-sm-4 milk_unit_change" style="display:<?= $sd_fed_dairy->milk_collection_unit == '1' ? 'block' : 'none'; ?>;">
                        ...
                        <div class="box-block-m">
                            <div class="col-sm-12">
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <label>13. Annual Total Fish Catch (in Tonne)<span
                                                class="important-field">*</span></label>
                                        <?=$this->Form->control("sd_federation_fishery[annual_fish_catch]",['label'=>false,'required'=>true,'class'=>'numbers','maxlength'=>'10', 'value'=>$sd_fed_fishery->annual_fish_catch])?>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-12">
                                ...
                                <div class="row sv-handling">
                                    <div class="col-sm-4">
                                        <label>14(a). Credit Facility <span class="important-field">*</span></label>
                                        <?=$this->Form->control("sd_federation_fishery[credit_facility]",['options'=>['1'=>'Yes','0'=>'No'],'default'=>0,'class'=>'f_credit_facility','type'=>'radio','label'=>false,'required'=>true, 'value'=>$sd_fed_fishery->credit_facility])?>
                                    </div>
                                    <div class="col-sm-4 f_credit_facility_change" style="display:<?= $sd_fed_fishery->credit_facility==1?'block':'none';?>;">
                                        <label>14(b). Total Credit Provided in the Financial Year (In Rs.) <span
                                                class="important-field">*</span></label>
                                        <?=$this->Form->control("sd_federation_fishery[total_credit_provided]",['label'=>false,'required'=>true,'class'=>'numbers','maxlength'=>'10', 'value'=>$sd_fed_fishery->total_credit_provided])?>
                                    </div>
                                    <div class="col-sm-4">
                                        <label>14(c). Distribution of Fuel <span
                                                class="important-field">*</span></label>
                                        <?=$this->Form->control("sd_federation_fishery[fuel_distribution]",['options'=>['1'=>'Yes','0'=>'No'],'default'=>0,'class'=>'f_distribution','type'=>'radio','label'=>false,'required'=>true, 'value'=>$sd_fed_fishery->fuel_distribution])?>
                                    </div>
                                    <div class="clearfix"></div>
                                    <div class="col-sm-4">
                                        <label>14(d). Marketing <span class="important-field">*</span></label>
                                        <?=$this->Form->control("sd_federation_fishery[marketing]",['options'=>['1'=>'Yes','0'=>'No'],'default'=>0,'class'=>'f_marketing','type'=>'radio','label'=>false,'required'=>true, 'value'=>$sd_fed_fishery->marketing])?>
                                    </div>
                                    <div class="col-sm-4">
                                        <label>14(e). Cold Storage <span class="important-field">*</span></label>
                                        <?=$this->Form->control("sd_federation_fishery[cold_storage]",['options'=>['1'=>'Yes','0'=>'No'],'default'=>0,'class'=>'f_cold_storage','type'=>'radio','label'=>false,'required'=>true, 'value'=>$sd_fed_fishery->cold_storage])?>
                                    </div>
                                    <div class="col-sm-4">
                                        <label>14(f). Transportation <span class="important-field">*</span></label>
                                        <?=$this->Form->control("sd_federation_fishery[transportation]",['options'=>['1'=>'Yes','0'=>'No'],'default'=>0,'class'=>'f_transportation','type'=>'radio','label'=>false,'required'=>true, 'value'=>$sd_fed_fishery->transportation])?>
                                    </div>
                                    <div class="col-sm-4">
                                        <label>14(g). Other Facilities Provided (Please Specify) <span
                                                class="important-field">*</span></label>
                                        <?=$this->Form->control("sd_federation_fishery[other_facility]",['label'=>false,'required'=>true, 'maxlength'=>'100','value'=>$sd_fed_fishery->other_facility])?>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="box-footer text-center">
                    ...
                    if($StateDistrictFederation->is_draft == 1){
                        ...
                        if($StateDistrictFederation->is_draft == 1){
                        echo $this->Html->link(__('Cancel'),['action' => 'draft'],['class' => 'btn btn-secondary mx-1','id' => 'cancel']); 
                        } else{
...
(function($) {
    ...
    $('body').on('change', '#affiliated-union-federation-level', function(e) {
        ...
        $('#affiliated-union-federation-other').val('');
        console.log(union_lavel, primary_activity, entity_type);
