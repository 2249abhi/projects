 ...
 */
$this->assign('title',__('PoliticalLife'));
$this->Breadcrumbs->add(__('PoliticalLife'));
      ...
      <div class="col-md-12">
        ...
        <div class="box box-primary">
          <div class="box-header">
              <h3 class="box-title"><?= __('Search - PoliticalLife'); ?></h3>
          </div> 
            ...
            <div class="box-body table-responsive">
              ...
              <div class="row2">    
                ...
                <div class="col-md-1">
                  ...
                  <?php } else { ?>
                    <?= $this->Html->link(__('Reset'),['controller'=>'PoliticalLife','action'=>'index'],['class'=>'btn btn-danger']); ?>
                  <?php }?>
                </div>
          ...
          <?= $this->Form->create('page_number',['id'=>'role_list','type'=>'get','class'=>'form-inline']); ?>
            <div class="box-header">
              ...
              <div class="box-tools">
                ...
                <?=$this->Html->link(
                    __('<i class="glyphicon glyphicon-plus"></i> New PoliticalLife'),
                    ['action' => 'add'],
                    ['class' => 'btn btn-success', 'escape' => false, 'title' => __('Add New PoliticalLife')]
                );?>                
              </div>              
            </div>
            <div class="clearfix"></div>
              ...
              <tbody>
				...
				foreach ($document_types as $role): ?>
                  <tr>
                    ...
                    <td><?= html_entity_decode($role->content); ?></td>
                    <td><?= html_entity_decode($role->orderno); ?></td>
                    <td><?= date('Y-m-d',strtotime($role->date)) ?></td>
                    ...
                    <td class="actions">
                        ...
                        <?= $this->Form->postLink('<i class="fa fa-trash-o"></i>', ['action' => 'delete', $role->id], ['confirm' => __('Are you sure you want to delete this Blog?', $role->id),'class' => 'btn btn-danger btn-xs', 'title' => __('Delete'), 'escape' => false]) ?>
                      </td>
                    </tr>
                    <?php $i++; endforeach; ?>
