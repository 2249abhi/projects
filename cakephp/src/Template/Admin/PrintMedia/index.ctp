 ...
 */
$this->assign('title',__('Download Page'));
$this->Breadcrumbs->add(__('Download Page'));
      ...
      <div class="col-md-12">
        ...
        <div class="box box-primary">
          <div class="box-header">
              <h3 class="box-title"><?= __('Search - Download Page'); ?></h3>
          </div> 
          ...
          <?= $this->Form->create('page_number',['id'=>'role_list','type'=>'get','class'=>'form-inline']); ?>
            <div class="box-header">
              ...
              <div class="box-tools">
                ...
                <?=$this->Html->link(
                    __('<i class="glyphicon glyphicon-plus"></i> New Download'),
                    ['action' => 'add'],
                    ['class' => 'btn btn-success', 'escape' => false, 'title' => __('Add New Download')]
                );?>                
              </div>              
            </div>
            <div class="clearfix"></div>
                ...
                <?php foreach ($roles as $role): ?>
                  <tr>
                    ...
                    <td class="actions">
                        ...
                        <?= $this->Form->postLink('<i class="fa fa-trash-o"></i>', ['action' => 'delete', $role->id], ['confirm' => __('Are you sure you want to delete this Role?', $role->id),'class' => 'btn btn-danger btn-xs', 'title' => __('Delete'), 'escape' => false]) ?>
                      </td>
                    </tr>
                    <?php endforeach; ?>
