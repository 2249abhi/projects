...
<section class="content Cooperative Registration index">
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <h3 style="line-height: 3.1;"><?= $sOption[$s_state] ?? '' ?></h3> <!-- <strong> Total Pacs:-<?php echo array_sum($district_nodal_tatal['pacs'][$state_code]); ?> </strong> -->
            </div>
        </div>
    </div>
    <?php } ?>
                    ...
                    <table class="table table-hover table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <th scope="col"><table class="table table-hover table-bordered table-striped"><thead><tr><th colspan="2"  style="text-align: center;"><?= $this->Paginator->sort('pacs','Pacs')?></th></tr><tr><th width="50%">Total <br>
                                    <?php 
                                    ...
                                    echo "Total  = ".$total_pac."<br>";
                                    ?></th> <th>Total Data Entered   <br>
                                    <?php 
                                ...
                                <th scope="col" style="text-align: center;">
                                 <table class="table table-hover table-bordered table-striped"><thead><tr><th colspan="2"  style="text-align: center;"><?= $this->Paginator->sort('dairy','Dairy') ?></th></tr><tr><th width="50%">Total <br>
                                    <?php 
                                    ...
                                    echo "Total  = ".$total_dairy."<br>";
                                    ?></th> <th>Total Data Entered 
                                ...
                                <th scope="col" style="text-align: center; width:233px">   <table class="table table-hover table-bordered table-striped"><thead><tr><th colspan="2"  style="text-align: center;"><?= $this->Paginator->sort('fisheries','Fisheries') ?></th></tr><tr><th width="50%">Total  <?php 
                                    ...
                                    echo "Total  = ".$total_fisfhery."<br>";
                                    ?></th> <th>Total Data Entered <br>  <?php 
                      ...
                      ?>
                                ...
                                <td><?= h($villages[$district_code['district_code']] ?? 0) ?></td>
                                  <td style="text-align: center;">
                                    <table class="table"><tbody><tr><td><?= h($district_nodal_tatal['pacs'][$state_code][$district_code['district_code']] ?? 0) ?></td><td width="50%">  <?= h($pacs[$district_code['district_code']] ?? 0) ?></td> </tr>
                                    </tbody></table> 
                                    </td>
                                <td style="text-align: center;">  

                                         <table class="table"><tbody><tr><td><?= h($district_nodal_tatal['dairy'][$state_code][$district_code['district_code']] ?? 0) ?></td><td width="50%">  <?= h($dairies[$district_code['district_code']] ?? 0) ?></th> </tr>
                                    </tbody></table>
                                ...
                                <td style="text-align: center;width: 223px;">
                                       ...
                                       <table class="table"><tbody><tr><td><?= h($district_nodal_tatal['fisfhery'][$state_code][$district_code['district_code']] ?? 0) ?></td><td width="50%">  <?= h($fisheries[$district_code['district_code']] ?? 0) ?></td> </tr>
                                    </tbody></table>
