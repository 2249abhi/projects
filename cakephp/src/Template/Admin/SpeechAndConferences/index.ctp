      ...
      <div class="col-xs-12">
        <div class="box box-primary">
          <?= $this->Form->create('page_number',['id'=>'role_list','type'=>'get','class'=>'form-inline']); ?>
            <div class="box-header">
              <h3 class="box-title">
                <?= __('List of') ?> <?= __('Speech and Conferences') ?>
              </h3>
              <div class="box-tools">
                <div class="form-group">
                ...
                <?=$this->Html->link(
                    __('<i class="glyphicon glyphicon-plus"></i> New Speech and Conference'),
                    ['action' => 'add'],
                    ['class' => 'btn btn-success', 'escape' => false, 'title' => __('Add New Speech and Conference')]
                );?>                
              </div>              
            </div>
            <div class="clearfix"></div>
