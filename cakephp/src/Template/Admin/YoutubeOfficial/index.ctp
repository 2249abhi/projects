 ...
 */
$this->assign('title',__('Youtube Official'));
$this->Breadcrumbs->add(__('Youtube Official'));
      ...
      <div class="col-xs-12">
        <div class="box box-primary">
          <?= $this->Form->create('page_number',['id'=>'role_list','type'=>'get','class'=>'form-inline']); ?>
            <div class="box-header">
              <h3 class="box-title">
                <?= __('List of') ?> <?= __('Youtube Official') ?>
              </h3>
              <div class="box-tools">
                <div class="form-group">
                ...
                <?=$this->Html->link(
                    __('<i class="glyphicon glyphicon-plus"></i> New Youtube Official'),
                    ['action' => 'add'],
                    ['class' => 'btn btn-success', 'escape' => false, 'title' => __('Add New Youtube Official video')]
                );?>                
              </div>              
            </div>
            <div class="clearfix"></div>
              ...
              <tbody>
				...
				foreach ($document_types as $role): ?>
                  <tr>
                    ...
                    <td><?= date('Y-m-d',strtotime($role->publish_date)) ?></td>
