 ...
 */
class MultiStateCooperativeExportItemsTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('multi_state_cooperative_export_items');
        ...
        // $this->belongsTo('MultiStateCooperatives.MultiStateCooperativeExportDetails',[
        //     'foreignKey' => 'multi_state_cooperative_id',
        //     'joinType' => 'INNER'
        // ]);
