 ...
 */
class MultiStateCooperativesTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('multi_state_cooperatives');
        ...
        $this->hasMany('MultiStateCooperativeSchemes', [
            'foreignKey' => 'multi_state_cooperative_id',
            'className'=>'MultiStateCooperativeSchemes',
            'dependent' => true
        ]);


        // $this->hasMany('MultiStateCooperativeMemberBrands', [
        //     'foreignKey' => 'multi_state_cooperative_id',
        //     'className'=>'MultiStateCooperativeMemberBrands'
        // ]);
