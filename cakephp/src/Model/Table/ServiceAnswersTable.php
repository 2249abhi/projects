 ...
 */
class ServiceAnswersTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('service_answers');
        $this->setDisplayField('answer_name');
        //$this->setDisplayField('orderseq');
        $this->setPrimaryKey('id');

        $this->addBehavior('Timestamp');

        $this->belongsTo('ServiceQuestions', [
            'foreignKey' => 'service_question_id',
            'joinType' => 'INNER'
        ]);

        // $this->hasOne('CooperativeRegistrations', [
        //     'foreignKey' => 'sector_of_operation',
        //     'className'=>'PrimaryActivities',
        // ]);  
    }
    ...
    {
        $rules->add($rules->existsIn(['department_id'], 'SectorOperations'));
