 ...
 */
class FederationTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('federation');
        $this->setDisplayField('federation_name');
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->scalar('federation_name')
            ->maxLength('federation_name', 255)
            ->requirePresence('federation_name', 'create')
            ->notEmpty('federation_name');
