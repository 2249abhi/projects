 ...
 */
class DistrictCoFedUnTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('dis_cop_fed_un');
        $this->setPrimaryKey('id');

        $this->addBehavior('Timestamp');
		$this->belongsTo('PrimaryActivities', [
            'foreignKey' => 'primaryactivity_id',
            'joinType' => 'INNER'
        ]);
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        // $validator
        //     ->scalar('name_of_the_union')
        //     ->maxLength('name_of_the_union', 255)
        //     ->requirePresence('name_of_the_union', 'create')
        //     ->notEmpty('name_of_the_union');
