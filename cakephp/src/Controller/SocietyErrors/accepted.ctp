            ...
            <div class="box box-primary">
                ...
                <div class="box-body table-responsive">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="status">Registration No.</label>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="status">Cooperative ID</label>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="page_name">Sector of Operation</label>
                                <?php echo $this->form->select('sector_operation',$sectorOperations,['class'=>'form-control','id'=>'sector_operation','empty'=>'--Select--','value'=>$s_sector_operation])?>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="page_name">Primary Activity</label>
                        ...
                        <div class="rural_filter" style="display:<?= $_GET['location'] == 2 ? 'block' : 'none' ; ?>;">
                        
                           
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="page_name">District</label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="page_name">Block</label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="page_name">Panchayat</label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="page_name">Village</label>
                        ...
                        <div class="urban_filter" style="display:<?= $_GET['location'] == 1 ? 'block' : 'none' ; ?>;">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="page_name">Local Category</label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="page_name">Local Name</label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="page_name">Ward</label>
                    ...
                    <div class="row">
                        <div class="col-md-12 text-center">
                            ...
                            <?= $this->Html->link(__('Reset'),['controller'=>'CooperativeRegistrations','action'=>'accepted'],['class'=>'btn btn-danger mx-1']); ?>
                        </div>
                    </div>
    ...
    <div class="row">
        <div>
             <div class="export_excel-div">
                    <button name="export_excel" value="export_excel" class="btn btn-green">Export to Excel</button>
                </div>
                <?= $this->Form->end(); ?>
            <?= $this->Flash->render(); ?>

            <div class="box box-primary box-st mt-1">
                    ...
                    <table class="table table-hover table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">
                                    <?= $this->Paginator->sort('district/urban_local_body','District/Urban Local Body') ?>
                                </th>
                                <th scope="col"><?= $this->Paginator->sort('sector','Primary Activity/Sector') ?></th>
                                <th scope="col">
                                    <?= $this->Paginator->sort('registration_number','Registration No.') ?></th>
                                ...
                                <th scope="col"><?= $this->Paginator->sort('sector_of_operation','Primary Activity') ?></th>
                ...
                ?>
                      ...
                      ?>
                                ...
                                <td><?= wordwrap($CooperativeRegistration->cooperative_society_name,42,'<br>') ?></td>
                                ...
                                <td><?= wordwrap($sectors[$CooperativeRegistration->sector_of_operation],42,'<br>') ?></td>
                                <td><?= wordwrap($CooperativeRegistration->registration_number,20,'<br/>') ?></td>
                                ...
                                <td><?= h($CooperativeRegistration->primary_activity['name']) ?></td>
                                <td class="actions">
                                    <?php 

                                    if($this->request->session()->read('Auth.User.role_id') == 8 && !in_array($CooperativeRegistration->sector_of_operation,$arr_valid_return))
                                    {
                                        //Admin
                                        ...
                                        echo  $this->Html->link('<i class="fa fa-history"></i>', ['action' => 'log-detail', $CooperativeRegistration->id],['class' => 'btn btn-info btn-xs', 'title' => __('History'), 'escape' => false]);
                                    }

                                    echo ' '.$this->Html->link('<i class="fa fa-eye"></i>', ['action' => 'view', $CooperativeRegistration->id],['class' => 'btn btn-info btn-xs', 'title' => __('View'), 'escape' => false]); 
                                    ?>
                                    <?php 
                                        if(in_array($CooperativeRegistration->sector_of_operation,$arr_valid_return) || 1 )
                                        {
                                            echo $this->Html->link('<i class="fa fa-edit"></i>', ['action' => 'edit', $CooperativeRegistration->id],['class' => 'btn btn-warning btn-xs', 'title' => __('Edit'), 'escape' => false]);
                                            //echo $this->Form->postLink('<i class="fa fa-trash-o"></i>', ['action' => 'delete', $CooperativeRegistration->id], ['confirm' => __('Are you sure you want to delete this Cooperative Registration?', $CooperativeRegistration->id),'class' => 'btn btn-danger btn-xs', 'title' => __('Delete'), 'escape' => false]);
                                        }
                                         ?>
                                </td>
                            </tr>
                    ...
                    <?php //if($this->request->session()->read('Auth.User.role_id') == 2 && count($CooperativeRegistrations) > 0){ //For admin reject 
                        if(($this->request->session()->read('Auth.User.role_id') == 8 && count($CooperativeRegistrations) > 0)){ //For admin reject 
...
$(document).ready(function() {
    ...
    $(".accept").click(function() {
        ...
        $.ajax({
            type: 'POST',
            cache: false,
            url: '<?=$this->Url->build(['action'=>'accept'])?>',
    ...
    $('#searchBanner').on('change', '#local_category', function(e) {
        ...
        $.ajax({
            ...
            data: {
                ...
                state_code: $('#state option:selected').val()
            },
            success: function(response) {
