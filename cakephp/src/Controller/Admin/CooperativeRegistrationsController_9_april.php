...
class CooperativeRegistrationsController extends AppController
{
    ...
    public function edit($id = null)
    {
        ...
        if ($this->request->is(['patch', 'post', 'put'])){
            ...
            $CooperativeRegistration = $this->CooperativeRegistrations->patchEntity($CooperativeRegistration, $data,['associated' => ['CooperativeRegistrationsHousing','CooperativeRegistrationsLabour','CooperativeRegistrationsConsumer','CooperativeRegistrationsLands','CooperativeRegistrationsMarketing','CooperativeRegistrationsCreditThrift']]);
  ...
  $this->viewBuilder()->setLayout('ajax');
   ...
   public function getdccb()
    ...
    public function pLabour()
    {
        ...
        $societytypes =$this->LabourSocietyTypes->find('list',['keyField'=>'id','valueField'=>'name'])->where(['status'=>1])->order(['orderseq'=>'ASC']);
        $this->set('societytypes',$societytypes);
