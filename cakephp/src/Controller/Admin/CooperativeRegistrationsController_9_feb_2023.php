...
class CooperativeRegistrationsController extends AppController
{
    ...
    public function index()
    {
		...
		$select = 
			['id','cooperative_society_name','state_code',
			 'state_name'=> "IF(states.name != '',states.name,CooperativeRegistrations.state_code)"];
        ...
        ])->contain(['states'])->where(['is_draft'=>0,'CooperativeRegistrations.status'=>1]);
