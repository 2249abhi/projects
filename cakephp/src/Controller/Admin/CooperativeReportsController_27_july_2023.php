...
public function numberOfmemberReport()
{
    ...
    public function districtwisesocietycountreport()
    {
        ...
        if(!empty($this->request->query['export_excel'])) {
            ...
            $headerRow = array("S.No", "Name","Agriculture and Allied Cooperative","Bee Farming Cooperative","Consumer Cooperative","Credit & Thrift Society","Dairy Cooperative","Educational and Training Cooperatives","Fishery Cooperative","Handicraft and Weaver Cooperative","Handloom Textile  & Weavers Cooperative","Jute and Coir Cooperative","Labour Cooperative","Livestock & Poultry Cooperative","Miscellaneous","Miscellaneous Credit Cooperative Society","Multipurpose Cooperative","Primary Agricultural Credit Society (PACS)","Primary Housing Cooperative Society","Primary Marketing Cooperative Society","Processing / Industrial Cooperative","Sericulture Cooperative","Social Welfare and Cultural Cooperative","Sugar Mills Cooperative","Tourism Cooperative","Transport Cooperative","Tribal-SC/ST Cooperative","Urban Cooperative Bank (UCB)","Women Welfare Cooperative Society");
            $data = array();
        ...
        $this->set(compact('states','districts','districts_data','flag'));
        ...
        $registrationQuery = $this->CooperativeRegistrations->find('all',
            ...
            if(!empty($districts))
            {
                ...
                foreach($districts as $district_code => $d_name)
                {
                    ...
                    $member_data = $this->CooperativeRegistrations->find('all',
                       )->join([
                        'states' => [
                            'table' => 'states',
                            'type' => 'INNER',
                        ...
                        ->where(['is_draft'=>0,'CooperativeRegistrations.status'=>1,'is_approved !='=>2,'members_of_society*1 <'=>1000000,'CooperativeRegistrations.state_code'=>1])
