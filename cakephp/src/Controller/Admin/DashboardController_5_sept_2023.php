...
class DashboardController extends AppController
{
    ...
    public function index()
    {
        ...
        $society_data = $this->DistrictReports->find('all')->select([
        ...
        $arr_member_data = $this->CooperativeRegistrations->find('all')
        ->select(['CooperativeRegistrations.sector_of_operation','total' => 'sum(CooperativeRegistrations.members_of_society)'])
            ...
            ->order(['CooperativeRegistrations.sector_of_operation'=>'ASC'])
            ->toArray();

            
        $member_data = array_column($arr_member_data, 'total', 'sector_of_operation');
        ...
        $this->set(compact('affliation_response','d_sectors','member_data','society_data'));
    }
