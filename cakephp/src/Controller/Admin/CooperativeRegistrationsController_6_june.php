...
class CooperativeRegistrationsController extends AppController
{
    ...
    public function beforeFilter(Event $event)
    {
        ...
        $this->Auth->allow(['getDistricts','getBlocks','getGp','getVillages','getUrbanLocalBodies','getUrbanLocalBody','getLocalityWard','getPrimaryActivity','getdccb','getfederationlevel','approval','bulkapproval','getUrbanRural','generateUniqueNumber','getBank']);
    }
     ...
     public function view($id = null)
    {
     ...
     // print_r($CooperativeRegistration);
      ...
      $this->set('localbodieswards',$localbodieswards);  
        ...
        $this->loadMOdel('TypeRawMaterial');
        $type_raw=$this->TypeRawMaterial->find('list',['keyField'=>'id','valueField'=>'name'])->where(['status'=>1 ,'primary_activity_id'=>14])->toArray();
        ...
        if($this->request->is('post')){
             ...
             if($data['is_draft'] == 0)
           {
            ...
            if($data['sector_of_operation'] == '90') 
            {
                ...
                $data['cooperative_registrations_jute']['facilities'] = implode(',',$data['cooperative_registrations_handicraft']['facilities']);
    ...
    public function edit($id = null)
    {
        ...
        if ($this->request->is(['patch', 'post', 'put'])){
            ...
            $CooperativeRegistration = $this->CooperativeRegistrations->patchEntity($CooperativeRegistration, $data,['associated' => ['CooperativeRegistrationsHousing','CooperativeRegistrationsLabour','CooperativeRegistrationsConsumer','CooperativeRegistrationsLands','CooperativeRegistrationsMarketing','CooperativeRegistrationsCreditThrift','CooperativeRegistrationsTransport','CooperativeRegistrationsProcessing','CooperativeRegistrationsHandloom','CooperativeRegistrationsAgriculture','CooperativeRegistrationsTribal','CooperativeRegistrationsTourism']]);
...
/*
        ...
        $this->loadMOdel('TypeRawMaterial');
        $type_raw=$this->TypeRawMaterial->find('list',['keyField'=>'id','valueField'=>'name'])->where(['status'=>1,'primary_activity_id'=>14]);
        $this->set('type_raw', $type_raw);
