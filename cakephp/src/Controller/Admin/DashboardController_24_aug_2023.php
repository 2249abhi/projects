...
class DashboardController extends AppController
{
    ...
    public function index()
    {
        ...
        $all_sector_data = $this->DistrictReports->find('all', [
        ...
        $all_sector_data = json_decode(json_encode($all_sector_data[0]),true);
        // $all_sector_data = json_decode($all_sector_data,true);

        $sector_name = str_replace('_',' ',array_keys($all_sector_data));
        arsort($all_sector_data);
        ...
        $this->set(compact('affliation_response','d_sectors','all_sector_data','sector_name'));
    }
