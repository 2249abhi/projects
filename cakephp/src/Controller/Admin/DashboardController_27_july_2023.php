...
class DashboardController extends AppController
{
    ...
    public function index()
    {
        ...
        $this->set(compact('pacs_graph','dairy_graph','fishery_graph','role_id','nodal_entry_id','states','districts','total_functional','total_under_liquition','non_functional','arr_gp_data','blocks','member'));
    ...
    public function getfederationdata($search_condition)
    {
        ...
        $registrationQuery_YES = $this->CooperativeRegistrations->find('all', [
           ...
           //'contain'=>['AreaOfOperationLevel','CooperativeRegistrationPacs'],
            'conditions' => [$search_condition2 , $search_condition]            
