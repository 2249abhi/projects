    ...
    public function index()
    {
       ...
       if(1==1)
       {
         ...
         //  print_r($state_code);
           ...
           // print_r($urban_bodys_wards);
           // print_r($urban_bodys);



           // COUNT(DISTINCT gram_panchayat_code)
           ...
           // print_r($villages);
            ...
            $dairies = $dairies->select(['state_code','count' => $dairies->func()->count('sector_of_operation')])->where(['sector_of_operation IN' => [9,37], 'is_draft'=>0,$condtion_district ,$condtion_location])->group(['state_code'])->toArray();


             //Dairies
             $dairies_today = $this->CooperativeRegistrations->find('list',['keyField'=>'state_code','valueField'=>'count']);
            
             $dairies_today = $dairies_today->select(['state_code','count' => $dairies_today->func()->count('sector_of_operation')])->where(['sector_of_operation IN' => [9,37],'is_draft'=>0,'DATE(created)' => date('Y-m-d'), $condtion_district,$condtion_location])->group(['state_code'])->toArray();
          ...
          //  print_r($district_nodal_tatal['pacs']);
          //  die;
          ...
          //  $state_code=$this->request->query['state'];
            ...
            $pacs_today = $pacs_today->select(['state_code','count' => $pacs_today->func()->count('sector_of_operation')])->where(['sector_of_operation IN' => [1,59,20,22],'is_draft'=>0, 'DATE(created)' => date('Y-m-d'), $condtion_district,$condtion_location])->group(['state_code'])->toArray();
          ...
          //  print_r($pacs_today);
            ...
            $fisheries = $fisheries->select(['state_code','count' => $fisheries->func()->count('sector_of_operation')])->where(['sector_of_operation IN' => [10,43],'is_draft'=>0, $condtion_district,$condtion_location])->group(['state_code'])->toArray();

            $fisheries_today = $this->CooperativeRegistrations->find('list',['keyField'=>'state_code','valueField'=>'count']);
            
            $fisheries_today = $fisheries_today->select(['state_code','count' => $fisheries_today->func()->count('sector_of_operation')])->where(['sector_of_operation IN' => [10,43],'is_draft'=>0,'DATE(created)' => date('Y-m-d'), $condtion_district,$condtion_location])->group(['state_code'])->toArray();
