...
class SectorsFederationsController extends AppController
{
    ...
    public function beforeFilter(Event $event)
    {
        ...
        $this->Auth->allow(['getDistricts','getBlocks','getGp','getVillages','getUrbanLocalBodies','getUrbanLocalBody','getLocalityWard','getPrimaryActivity','getdccb','getfederationlevel','approval','bulkapproval','getUrbanRural','generateUniqueNumber','add','getSociety']);
    }
    ...
    public function add()
    {
        ...
        $this->set(compact('cooperative_society_name','CooperativeFederation','states','PresentFunctionalStatus','years','state_code','districts','localbody_types','designations','PrimaryActivities'));
   ...
   public function getdccb()
    ...
    public function getSociety()
    {
        ...
        if($this->request->is('ajax'))
        {
            ...
            //echo $operation_area_location;die;
            $this->loadMOdel('DisCopFedUn');
            $arr_area_of_operations=$this->DisCopFedUn->find('list',['keyField'=>'id','valueField'=>'name'])->where(['district_code'=>$district_code,'primaryactivity_id'=>$primary_activity])->order(['name'=>'ASC']);
