    ...
    public function edit($id = null)
    {
        ...
        // Start States for dropdown
          //  $this->loadModel('States');
            ...
            $all_states = $states=$this->States->find('list',['keyField'=>'state_code','valueField'=>'name'])->order(['name'=>'ASC'])->where(['flag'=>1]);
            $this->set('all_states',$all_states);
        // End States for dropdown
        ...
        $this->loadMOdel('UrbanLocalBodies');
        $localbodies=$this->UrbanLocalBodies->find('list',['keyField'=>'localbody_code','valueField'=>'local_body_name'])->where(['status'=>1,'localbody_type_code'=>$StateCooperativeBank->urban_local_body_type_code,'state_code'=>$StateCooperativeBank->state_code])->order(['local_body_name'=>'ASC']);
