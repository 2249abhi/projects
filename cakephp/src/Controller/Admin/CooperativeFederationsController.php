 ...
 */
class CooperativeFederationsController extends AppController
{
    ...
    public function add()
    {
       ...
       $this->set('designations',$designations);
        ...
        // Start PrimaryActivities for dropdown
            ...
            $PrimaryActivities=$this->PrimaryActivities->find('list',['keyField'=>'id','valueField'=>'name'])->where(['sector_of_operation'=>$CooperativeFederation->sector_of_operation_type,'status'=>1])->order(['orderseq'=>'ASC']);
