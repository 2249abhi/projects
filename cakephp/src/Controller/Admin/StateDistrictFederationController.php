    ...
    public function add()
    {
       ...
       $this->set('designations',$designations);
        ...
        // Start PrimaryActivities for dropdown
            ...
            $this->loadModel('PrimaryActivities');
            $PrimaryActivitiesTotal=$this->PrimaryActivities->find('list',['keyField'=>'id','valueField'=>'name'])->where(['status'=>1])->order(['orderseq'=>'ASC']);
        // End PrimaryActivities for dropdown
    ...
    public function edit($state_district_federation_id = null)
    {
      ...
      //queries for table "Sd Federation Lands" common to Housing, Marketing
       ...
       $this->loadMOdel('UrbanLocalBodies');
        ...
        $this->set(compact('curr_federation','arr_banks','StateDistrictFederation','PrimaryActivitiesTotal','CooperativeRegistration','states','CooperativeSocietyTypes','areaOfOperationsUrban','areaOfOperationsRural','PrimaryActivities','SecondaryActivities','PresentFunctionalStatus','years','state_code'));
