...
$this->assign('content_header',__('List of Cooperative Registrations History'));
...
<section class="content Cooperative Registration index">
        ...
        <div class="col-xs-12">
            ...
            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title titleSrch"><?= __('Search - Cooperative Society History'); ?></h3>
                    <div class="SrchBx">
    ...
    <div class="col-md-3">
                        ...
                        <div class="row3">
                            <div class="col-md-12 text-center">
                                <button name="search_button" value="search_button" type="submit"
                                    class="btn btn-primary btn-green">Search <?= $id ?></button>
                                <?= $this->Html->link('Reset', ['action' => 'logDetail', $id],['class' => 'btn btn-danger mx-1']) ?>
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box box-primary box-st box-top">
                        ...
                        <table class="table table-hover table-bordered table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col"><?= $this->Paginator->sort('sector','Sector Name') ?></th>
                                    <th scope="col">
                                        <?= $this->Paginator->sort('registration_number','Registration Number') ?></th>
                                    <th scope="col"><?= $this->Paginator->sort('cooperative_id','Cooperative ID') ?>
                                    </th>
                                    <th scope="col"><?= $this->Paginator->sort('created_by','Created By') ?></th>
                                    <th scope="col"><?= $this->Paginator->sort('reference_rear','Reference Year') ?>
                                    </th>
                                    <th scope="col">
                                    ...
                                    <th scope="col"><?= $this->Paginator->sort('updated_at','Updated At') ?></th>
                ...
                ?>
                      ...
                      ?>
                                 ...
                                 ?>
                                    ...
                                    <td><?= wordwrap($sectors[$CooperativeRegistration->sector_of_operation],25,'<br>') ?></td>
                                    ...
                                    <td><?php 
                                    $utime = new FrozenTime($CooperativeRegistration->logged_at);
                                    echo $utime->format('d/m/Y h:i:s');
                                ?></td>
                                    <td class="actions">
                                        <?= $this->Html->link('<i class="fa fa-eye"></i>', ['action' => 'log-view', $CooperativeRegistration->id],['class' => 'btn btn-info btn-xs', 'title' => __('View'), 'escape' => false]) ?>
