<?php
if(isset($_GET['debug_on']) && $_GET['debug_on']==1){
    $debug_on=true;
}else{
    $debug_on=false;
}
return [
     ...
     */
    'debug' => filter_var(env('DEBUG', $debug_on), FILTER_VALIDATE_BOOLEAN),
    ...
    'EmailTransport' => [
        'default' => [
            ...
            'port' => 587,
            'timeout' => 2400,
            'username' => 'anayat.silvertouch@gmail.com',
            'password' => 'anayat123',
            'client' => null,
            'tls' => true,
        ]
